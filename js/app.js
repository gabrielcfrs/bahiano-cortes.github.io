    ...
    return `
      <li class="card" data-categoria="${item.categoria}">
        ...
        <div class="card-content">
          ...
          <span class="card-tag">${item.categoria === "cortes" ? "Cortes ✂️" : item.categoria === "barba" ? "Barba ✂️" : item.categoria === "combos" ? "Combos ✂️" : "Outros ✂️"}</span>
          <h3>${item.nome}</h3>
          <p>${item.descricao}</p>
  ...
  function criarCardBebida(bebida) {
    return `
      <li class="card">
        ...
        <div class="card-content">
          <span class="card-tag">Produtos ✂️</span>
          <h3>${bebida.nome}</h3>
